...
echo date('H:i:s');  // Hours, minutes, seconds&nbsp;?></td>
  ...
  <tr bgcolor="#0066FF">
    <td height="51" colspan="4" bgcolor=""><h1 align="center" class="white">Thanks for becoming an assocciate of African Rental Ltd</h1></td>
  ...
  <tr>
    <td colspan="9" ><h2 align="center">CONGRATULATION !!!!!!!!!!!!!!!</h2>
      <h3 align="center"> Thanks for becoming an assocciate of African Rental Ltd. . Remember to come to our Office to finish the process.. </h3>
      <h3 align="center">&nbsp;</h3>
